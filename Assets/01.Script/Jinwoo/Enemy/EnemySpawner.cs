...
public class EnemySpawner : MonoBehaviour
{
    ...
    public List<SpawnWaveDataSO> _waveData = new List<SpawnWaveDataSO>();
    ...
    void WeightSetting()
    {
        var wrPicker = new Jinwoo.WeightedRandomPicker<EnemyDataSO>();

        // 아이템 및 가중치 목록 전달
        wrPicker.Add(

            (_waveData[0]._enemyList[0], 332),

            (_waveData[1]._enemyList[1], 1200),

            (_waveData[2]._enemyList[2], 500),

            (_waveData[3]._enemyList[3], 700)
        );
